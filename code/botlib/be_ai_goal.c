...
//the game type
//WIIU: static — this file's local name for the goal-weight gametype value
//happens to collide with g_main.c's g_gametype vmCvar_t once qagame is
//statically linked into the same binary (see Makefile.client GAME_SRCS).
